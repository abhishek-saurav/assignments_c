...
| File Name | Link |
|-----------|------|
| data-types.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-38/data-types.py |
| python-operators.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-38/python-operators.py |
| string-operations.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-38/string-operations.py |
| number-swap.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-38/number-swap.py |

### Lesson 39

| File Name | Link |
|-----------|------|
| odd-even.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-39/odd-even.py |
| bmi-calculator.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-39/bmi-calculator.py |
| double-check-number.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-39/double-check-number.py |
| date-time-operations.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-39/date-time-operations.py |

### Lesson 40

| File Name | Link |
|-----------|------|
| table-of-23.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-40/table-of-23.py |
| star-pattern.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-40/star-pattern.py |
| natural-numbers-sum.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-40/natural-numbers-sum.py |
| prime-number.py | https://github.com/abhishek-saurav/assignments_c/blob/main/m7/activities/lesson-40/prime-number.py |
